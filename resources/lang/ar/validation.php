...
return [
    ...
    */
    'attributes' => [
        ...
        'e_date_en'             => 'تاريخ الإنشاء',
        'about_en'              => 'نبذه بالإنجليزيه',
        'about_ar'              => 'نبذه بالعربيه',
        'site'                  => 'الموقع الإلكتروني',
        'contact_email'         => 'بريد الإتصال',
        'img'                   => 'الصوره',
        'images.*'              => 'الصور',
        'experience'            => 'سنوات الخبره',
        'title_ar'              => 'العنوان بالعربيه',
        'title_en'              => 'العنوان بالإنجليزيه',
        'content_ar'            => 'المحتويالعربي',
        'content_en'            => 'المحتوي الإنجليزي',
        'category_id'           => 'القسم',
        'until'                 =>'ساري حتي',
        'booktime'              =>' موعد الحجز',
        ...
        'from'                  =>'من',
        'to'                    =>'إلي',
        'from2'                 =>'من الفتره الثانيه',
        'to2'                   =>'إلي الفتره الثانيه',
        'periods_number'        =>'عددالفترات',
        'location'              =>'الموقع',
        'city_id'               =>'المدينة',
        'price'                 =>'السعر',
        'comment'               => 'التعليق',
